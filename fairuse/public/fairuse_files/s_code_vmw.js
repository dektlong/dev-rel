...
/* Single tracking JS file - for siteCatelyst tracking */
...
if (window.location.host == 'redesign.vmware.com' || window.location.host == 'wcm.vmware.com' || window.location.host == 'wcm-training.vmware.com' || window.location.host == 'wcm-intl.vmware.com' || window.location.host == 'wwwa-dev-sso-1.vmware.com' || window.location.host == 'wwwa-qa-sso-1.vmware.com' || window.location.host == 'govirtual-jive-dev-1.vmware.com' || window.location.host == 'vmweb-test.vmware.com' || window.location.host == 'supportuat.vmware.com' || window.location.host == 'vmshare-stage.vmware.com'  || window.location.host.match(/^siebwebdev/) || window.location.host.match(/^siebwebtest/) || window.location.host.match(/^eservice-stage/) || window.location.host.match(/^phnx-portal/) || window.location.host == 'newcastle.vmware.com' || window.location.host == 'vmworld2009-test.wingateweb.com' || window.location.host == 'portal-vmwperf.vmware.com' || window.location.host == 'cs2.salesforce.com' || window.location.host.match(/^vam-dev/)) {	
        ...
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false		
} else if (window.location.host.match(/cloudfoundry.(com|org)/)) {
        s_account="vmwarecloudfoundry"
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false		
} 
else if (window.location.hostname == "labs.vmware.com") {
        s_account="vmwarelabs"
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false
}
...
else if (window.location.hostname == "s2-dev-icewm-1.vmware.com" || window.location.hostname == "dma.vmware.com" || window.location.hostname == "dmadev.vmware.com" || window.location.hostname == "dmatest.vmware.com" || window.location.pathname.match(/^\/dpa\//)) {
        s_account="vmwaredmw"
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false
}
else if (window.location.host.match('vmworld.com') || window.location.host.match('vmworld2008.com') || window.location.host == "vmworld2008.wingateweb.com" || window.location.host.match("vmworldeurope09.com") || window.location.host.match(/vmworld20[1-9]\d.wingateweb.com/) || window.location.host.match(/vmworldeurope20[1-9]\d.com/) || (window.location.host=="mylearn1.vmware.com" && window.location.pathname=="/mgrCourse/launchCourse.cfm" && document.title.match("VMworld"))) {
        var s=s_gi(s_account)
        s.dynamicAccountSelection=true
        s.dynamicAccountList="vmwarevmworld,vmwareglobal=vmworld.com;vmwarevmworld,vmwareglobal=vmworld2008.com;vmwarevmworld,vmwareglobal=vmworld2008.wingateweb.com;vmwarevmworld,vmwareglobal=vmworldeurope09.com;vmwarevmworld,vmwareglobal=vmworld2011.wingateweb.com;vmwarevmworld,vmwareglobal=vmworldeurope2011.com"
        ...
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false
} else if (window.location.pathname.match(/(01Z80000001FnnM|01Z80000001FnhY|01Z80000001FnhT|01Z80000001FnsW)/)) {
        s_account="vmwaresalesforce"
        var s=s_gi(s_account)
        s.dynamicAccountSelection=false		
...
s.linkInternalFilters="javascript:,vmware.com,vmworld.com,vmworld2008.com,vmworld2008.wingateweb.com,vmworldeurope09.com,vmworld2011.wingateweb.com,vmworldeurope2011.com,vmwareyourtime.com"
...
function s_doPlugins(s) {
  ...
  if (!s.prop6) {s.prop6=(url.q)?url.q.toLowerCase():'';}
  ...
  /* For mylearn.vmware.com -- change it to all lower case */
  if(s.pageName && s.pageName.split(':')[1] == ' mylearn ') {
...
+"pu,@E,`b`gspace,c`V,`s@6,#1`g,^H,^1,@H';^Y=^X+',^m,$O,server,#1^K,$w@5ID,purchaseID,@p,state,zip,$f,products,`N`g,`N^K';^B`Kn=1;n<76;n++)^Y+=',prop$F+',eVar$F+',hier$F;^X2=',^S,^2,`n^j,`d,`s@8,`y@1"
...
try {
     ...
     for (var i = 0; i < url.hierarchy.length; i++) {
		...
		s.eVar43=url.eVar43
		s.prop34=s.pageName
        s.prop23 = "External_Hosts"
        s.prop30 = url.prop30 || "";
        s.prop37=s.evar37=url.prop37 || "";
        s.eVar22 = url.evar22 || ""
        /* Conversion Variables */
        s.campaign = ""
        s.events = url.events || "";
		/* added for vmworld2011 successful registration tracking */
		if (url.pathname == '/portal/reg/hotelOption.ww' && document.referrer == 'https://vmworld2011.wingateweb.com/portal/reg/payment.ww') {
			s.events = "event21";
		}
